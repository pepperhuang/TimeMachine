...
writematrix(stats.W,'weights_1sample_5_100_CPhrs.csv');
writematrix(index,'indices_1sample_5_100_CPhrs.csv');
...
writematrix(beta,'RegressionCoefficients_PLSR_1sample_5_100_CPhrs.xlsx');

%% Save model variables
model.index=index
model.beta=beta
model.max_var=max_var
save model_NC5_G100_1sample_CPhrs model
